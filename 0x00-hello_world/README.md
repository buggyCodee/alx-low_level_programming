...
- [Why I don't recommend C++ for beginners.](https://youtu.be/KGFOLJiIo1g)

- [Clarifying about literals, macros, and const (still not constant?)](https://youtu.be/UCCuzd9haoo)
- [A const int is not a constant.](https://youtu.be/8a3HyL1VN0Q)
- [Defining Constants. Should I use CONST or #DEFINE?](https://youtu.be/ZIhy4uy5uJM)
- [Why do programmers use hexadecimal numbers?](https://youtu.be/dPxCGlW9lfM)
